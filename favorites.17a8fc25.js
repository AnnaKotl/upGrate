!function(){function t(t){return t&&t.__esModule?t.default:t}function e(t,e,n,i){Object.defineProperty(t,e,{get:n,set:i,enumerable:!0,configurable:!0})}var n="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},i={},r={},o=n.parcelRequired7c6;null==o&&((o=function(t){if(t in i)return i[t].exports;if(t in r){var e=r[t];delete r[t];var n={id:t,exports:{}};return i[t]=n,e.call(n.exports,n,n.exports),n.exports}var o=Error("Cannot find module '"+t+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(t,e){r[t]=e},n.parcelRequired7c6=o);var a=o.register;a("d0Tth",function(n,i){e(n.exports,"favoriteArr",function(){return u});var r=o("1VFfL"),a=o("89MHW"),s=o("4T9EK");let l=document.querySelector(".recipes-list"),c=9,u=JSON.parse(localStorage.getItem("favorites"))||[];function f(t){t.preventDefault();let e=t.currentTarget.id;(0,a.showModalAboutReciepts)(e)}function p(t){return t.closest(".cards").dataset.id}async function d(e=1){try{let n=await fetch(`https://tasty-treats-backend.p.goit.global/api/recipes?limit=${c}&page=${e}`);if(!n.ok)throw Error(n.status);let i=await n.json(),o=i.results.map(({_id:e,title:n,category:i,rating:r,preview:o,tags:a,instructions:l,area:c,time:u,ingredients:f})=>`<li class="cards ${i}" data-id="${e}">
          ...
          <div class="recipe-desc">
            ...
            <p class="${c} hidden"></p>
            <p class="${u} hidden"></p>
            <p class="(${f.map(({measure:t})=>t).join(", ")}) hidden"></p>
          </div>
 ...
 *     'play': handler
 * }, myObj);
 */f.prototype.on=function(t,e,n){var i=this;o(t)?c(// [syntax 1, 2]
 ...
 * @param {function|object} [handler] - handler function or context
 * @param {object} [context] - context for binding
 */f.prototype.once=function(t,e,n){var i=this;if(a(t)){n=e,c(t,function(t,e){i.once(e,t,n)});return}this.on(t,function r(){e.apply(n,arguments),i.off(t,r,n)},n)},/**
 * Splice supplied array by callback result
 * @param {array} arr - array to splice
 * @param {function} predicate - function return boolean
 * @private
 */f.prototype._spliceMatches=function(t,e){var n,i=0;if(s(t))for(n=t.length;i<n;i+=1)!0===e(t[i])&&(t.splice(i,1),n-=1,i-=1)},/**
 ...
 * @private
 */f.prototype._matchHandlerAndContext=function(t,e){var n=this;return function(i){var r=t===i.handler,o=e===i.context,a=r&&o;return a&&n._forgetContext(i.context),a}},/**
 * Unbind event by event name
 * @param {string} eventName - custom event name to unbind
 * @param {function} [handler] - handler function
 * @private
 */f.prototype._offByEventName=function(t,e){var n=this,i=l(e),r=n._matchHandler(e);c(t=t.split(u),function(t){var e=n._safeEvent(t);i?n._spliceMatches(e,r):(c(e,function(t){n._forgetContext(t.context)}),n.events[t]=[])})},/**
 * Unbind event by handler function
 * @param {function} handler - handler function
 * @private
 */f.prototype._offByHandler=function(t){var e=this,n=this._matchHandler(t);c(this._safeEvent(),function(t){e._spliceMatches(t,n)})},/**
 ...
 * CustomEvents.off();
 */f.prototype.off=function(t,e){o(t)?this._offByEventName(t,e):arguments.length?l(t)?this._offByHandler(t):a(t)&&this._offByObject(t,e):(// [syntax 8]
...
return e.prototype=t,new e};/***/},/* 20 *//***/function(t,e,n){var i=n(3),r=n(7),o=n(21),a=n(22),s=n(24),l=n(25),c=n(0),u=n(4),f=n(28),p=n(9),d={page:'<a href="#" class="tui-page-btn">{{page}}</a>',currentPage:'<strong class="tui-page-btn tui-is-selected">{{page}}</strong>',moveButton:'<a href="#" class="tui-page-btn tui-{{type}}"><span class="tui-ico-{{type}}">{{type}}</span></a>',disabledMoveButton:'<span class="tui-page-btn tui-is-disabled tui-{{type}}"><span class="tui-ico-{{type}}">{{type}}</span></span>',moreButton:'<a href="#" class="tui-page-btn tui-{{type}}-is-ellip"><span class="tui-ico-ellip">...</span></a>'},h=["first","prev","next","last"],m=["prev","next"],g=r(/** @lends View.prototype */{init:function(t,e,n){/**
       * Root element
       * @type {HTMLElement}
       * @private
     ...
     * @private
     */_setRootElement:function(t){if(u(t)?t=document.getElementById(t)||document.querySelector(t):t.jquery&&(t=t[0]),!f(t))throw Error("The container element is invalid.");this._containerElement=t},/**
     * Assign move buttons to option
     * @private
     */_setMoveButtons:function(){i(h,function(t){this._buttons[t]=p.createElementByTemplate(this._template.moveButton,{type:t})},this)},/**
     * Assign disabled move buttons to option
     * @private
     */_setDisabledMoveButtons:function(){i(h,function(t){var e="disabled"+p.capitalizeFirstLetter(t);this._buttons[e]=p.createElementByTemplate(this._template.disabledMoveButton,{type:t})},this)},/**
     * Assign more buttons to option
     * @private
     */_setMoreButtons:function(){i(m,function(t){this._buttons[t+"More"]=p.createElementByTemplate(this._template.moreButton,{type:t})},this)},/* eslint-enable camelcase *//**
 ...
 * @author NHN FE Development Lab <dl_javascript@nhn.com>
 */var i=n(8),r=n(3),o=n(2),a=n(4),s=n(0),l=/{{\s?|\s?}}/g,c=/^[a-zA-Z0-9_@]+\[[a-zA-Z0-9_@"']+\]$/,u=/\[\s?|\s?\]/,f=/^[a-zA-Z_]+\.[a-zA-Z_]+$/,p=/\./,d=/^["']\w+["']$/,h=/"|'/g,m=/^-?\d+\.?\d*$/,g={if:/**
 ...
 * @private
 */// eslint-disable-next-line complexity
function x(t,e){var n,i=e[t];return"true"===t?i=!0:"false"===t?i=!1:d.test(t)?i=t.replace(h,""):c.test(t)?i=x((n=t.split(u))[0],e)[x(n[1],e)]:f.test(t)?i=x((n=t.split(p))[0],e)[n[1]]:m.test(t)&&(i=parseFloat(t)),i}/**
...
w.CanceledError=u.default,w.CancelToken=f.default,w.isCancel=p.default,w.VERSION=d.VERSION,w.toFormData=h.default,// Expose AxiosError class
...
w.mergeConfig=s.default,w.AxiosHeaders=x.default,w.formToJSON=t=>(0,c.default)((0,i.default).isHTMLForm(t)?new FormData(t):t),w.getAdapter=b.default.getAdapter,w.HttpStatusCode=v.default,w.default=w;var k=w}),a("c4C4W",function(t,i){e(t.exports,"default",function(){return j});var r,a,s=o("lGmLA");// utils is a library of generic helper functions non-specific to axios
let{toString:l}=Object.prototype,{getPrototypeOf:c}=Object,u=(r=Object.create(null),t=>{let e=l.call(t);return r[e]||(r[e]=e.slice(8,-1).toLowerCase())}),f=t=>(t=t.toLowerCase(),e=>u(e)===t),p=t=>e=>typeof e===t,{isArray:d}=Array,h=p("undefined"),m=f("ArrayBuffer"),g=p("string"),y=p("function"),x=p("number"),b=t=>null!==t&&"object"==typeof t,v=t=>{if("object"!==u(t))return!1;let e=c(t);return(null===e||e===Object.prototype||null===Object.getPrototypeOf(e))&&!(Symbol.toStringTag in t)&&!(Symbol.iterator in t)},w=f("Date"),k=f("File"),_=f("Blob"),S=f("FileList"),C=f("URLSearchParams");/**
 ...
 *
 * @returns {boolean}
 */function(t){return!!(t&&y(t.append)&&"FormData"===t[Symbol.toStringTag]&&t[Symbol.iterator])},toJSONObject:t=>{let e=Array(10),n=(t,i)=>{if(b(t)){if(e.indexOf(t)>=0)return;if(!("toJSON"in t)){e[i]=t;let r=d(t)?[]:{};return E(t,(t,e)=>{let o=n(t,i+1);h(o)||(r[e]=o)}),e[i]=void 0,r}}return t};return n(t,0)},isAsyncFn:D,isThenable:t=>t&&(b(t)||y(t))&&y(t.then)&&y(t.catch)}}),a("lGmLA",function(t,n){e(t.exports,"default",function(){return i});function i(t,e){return function(){return t.apply(e,arguments)}}}),a("9jbh3",function(t,n){e(t.exports,"default",function(){return h});var i=o("c4C4W"),r=o("6d5Pb"),a=o("JRZh2"),s=o("k04r0"),l=o("knWMA"),c=o("gYMA1"),u=o("9SeBc"),f=o("gHHim");let p=u.default.validators;/**
 ...
 */class d{constructor(t){this.defaults=t,this.interceptors={request:new a.default,response:new a.default}}/**
   ...
   */request(t,e){let n,r;"string"==typeof t?(e=e||{}).url=t:e=t||{},e=(0,l.default)(this.defaults,e);let{transitional:o,paramsSerializer:a,headers:c}=e;void 0!==o&&(0,u.default).assertOptions(o,{silentJSONParsing:p.transitional(p.boolean),forcedJSONParsing:p.transitional(p.boolean),clarifyTimeoutError:p.transitional(p.boolean)},!1),null!=a&&((0,i.default).isFunction(a)?e.paramsSerializer={serialize:a}:(0,u.default).assertOptions(a,{encode:p.function,serialize:p.function},!0)),// Set config.method
e.method=(e.method||this.defaults.method||"get").toLowerCase();// Flatten headers
let d=c&&(0,i.default).merge(c.common,c[e.method]);c&&(0,i.default).forEach(["delete","get","head","post","put","patch","common"],t=>{delete c[t]}),e.headers=(0,f.default).concat(d,c);// filter out skipped interceptors
 ...
 */function a(t){return encodeURIComponent(t).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function s(t,e,n){let o;/*eslint no-param-reassign:0*/if(!e)return t;let s=n&&n.encode||a,l=n&&n.serialize;if(o=l?l(e,n):(0,i.default).isURLSearchParams(e)?e.toString():new(0,r.default)(e,n).toString(s)){let e=t.indexOf("#");-1!==e&&(t=t.slice(0,e)),t+=(-1===t.indexOf("?")?"?":"&")+o}return t}}),a("8zJup",function(t,n){e(t.exports,"default",function(){return l});var i=o("12Kat");/**
...
t=c(t),!n&&e?"["+t+"]":t)}).join(n?".":""):e}let f=(0,i.default).toFlatObject(i.default,{},null,function(t){return/^is[A-Z]/.test(t)});var p=/**
...
return!(0,i.default).isUndefined(e[t])});let o=n.metaTokens,p=n.visitor||x,d=n.dots,h=n.indexes,m=n.Blob||"undefined"!=typeof Blob&&Blob,g=m&&(0,i.default).isSpecCompliantForm(e);if(!(0,i.default).isFunction(p))throw TypeError("visitor must be a function");function y(t){if(null===t)return"";if((0,i.default).isDate(t))return t.toISOString();if(!g&&(0,i.default).isBlob(t))throw new r.default("Blob is not supported. Use a Buffer instead.");return(0,i.default).isArrayBuffer(t)||(0,i.default).isTypedArray(t)?g&&"function"==typeof Blob?new Blob([t]):s.from(t):t}/**
   * Default visitor.
   *
   * @param {*} value
...
n=c(n),a.forEach(function(t,r){(0,i.default).isUndefined(t)||null===t||e.append(!0===h?u([n],r,d):null===h?n:n+"[]",y(t))}),!1)}}return!!l(t)||(e.append(u(r,n,d),y(t)),!1)}let b=[],v=Object.assign(f,{defaultVisitor:x,convertValue:y,isVisitable:l});if(!(0,i.default).isObject(t))throw TypeError("data must be an object");return function t(n,r){if(!(0,i.default).isUndefined(n)){if(-1!==b.indexOf(n))throw Error("Circular reference detected in "+r.join("."));b.push(n),(0,i.default).forEach(n,function(n,o){let a=!((0,i.default).isUndefined(n)||null===n)&&p.call(e,n,(0,i.default).isString(o)?o.trim():o,r,v);!0===a&&t(n,r?r.concat(o):[o])}),b.pop()}}(t),e}}),a("5TB86",function(t,n){e(t.exports,"default",function(){return l});var i=o("c4C4W");/**
...
r.from=(t,e,n,o,s,l)=>{let c=Object.create(a);return(0,i.default).toFlatObject(t,c,function(t){return t!==Error.prototype},t=>"isAxiosError"!==t),r.call(c,t.message,e,n,o,s),c.cause=t,c.name=t.name,l&&Object.assign(c,l),c};var l=r}),a("beknR",function(t,n){e(t.exports,"default",function(){return i});// eslint-disable-next-line strict
var i=null}),a("3aNd6",function(t,n){e(t.exports,"Buffer",function(){return i},function(t){return i=t}),e(t.exports,"INSPECT_MAX_BYTES",function(){return r},function(t){return r=t});var i,r,a=o("5d11t"),s=o("7rddL");let l="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
if("number"==typeof t){if("string"==typeof e)throw TypeError('The "string" argument must be of type string. Received type number');return d(t)}return f(t,e,n)}function f(t,e,n){if("string"==typeof t)return function(t,e){if(("string"!=typeof e||""===e)&&(e="utf8"),!u.isEncoding(e))throw TypeError("Unknown encoding: "+e);let n=0|y(t,e),i=c(n),r=i.write(t,e);return r!==n&&// cause everything after the first invalid character to be ignored. (e.g.
 ...
 **/u.from=function(t,e,n){return f(t,e,n)},// Note: Change prototype *after* Buffer.from is defined to workaround Chrome bug:
// https://github.com/feross/buffer/pull/148
Object.setPrototypeOf(u.prototype,Uint8Array.prototype),Object.setPrototypeOf(u,Uint8Array),/**
 * Creates a new filled Buffer instance.
 * alloc(size[, fill[, encoding]])
 **/u.alloc=function(t,e,n){return(p(t),t<=0)?c(t):void 0!==e?"string"==typeof n?c(t).fill(e,n):c(t).fill(e):c(t)},/**
...
let P={};function O(t,e,n){P[t]=class extends n{constructor(){super(),Object.defineProperty(this,"message",{value:e.apply(this,arguments),writable:!0,configurable:!0}),// Add the error code to the name to include it in the stack trace.
this.name=`${this.name} [${t}]`,// Access the stack to generate the error message including the error code
// from the name.
this.stack// eslint-disable-line no-unused-expressions
,// Reset the name to the actual name.
delete this.name}get code(){return t}set code(t){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:t,writable:!0})}toString(){return`${this.name} [${t}]: ${this.message}`}}}function B(t){let e="",n=t.length,i="-"===t[0]?1:0;for(;n>=i+4;n-=3)e=`_${t.slice(n-3,n)}${e}`;return`${t.slice(0,n)}${e}`}function R(t,e,n,i,r,o){if(t>n||t<e){let i;let r="bigint"==typeof e?"n":"";throw i=o>3?0===e||e===BigInt(0)?`>= 0${r} and < 2${r} ** ${(o+1)*8}${r}`:`>= -(2${r} ** ${(o+1)*8-1}${r}) and < 2 ** ${(o+1)*8-1}${r}`:`>= ${e}${r} and <= ${n}${r}`,new P.ERR_OUT_OF_RANGE("value",i,t)}I(r,"offset"),(void 0===i[r]||void 0===i[r+o])&&M(r,i.length-(o+1))}function I(t,e){if("number"!=typeof t)throw new P.ERR_INVALID_ARG_TYPE(e,"number",t)}function M(t,e,n){if(Math.floor(t)!==t)throw I(t,n),new P.ERR_OUT_OF_RANGE(n||"offset","an integer",t);if(e<0)throw new P.ERR_BUFFER_OUT_OF_BOUNDS;throw new P.ERR_OUT_OF_RANGE(n||"offset",`>= ${n?1:0} and <= ${e}`,t)}O("ERR_BUFFER_OUT_OF_BOUNDS",function(t){return t?`${t} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError),O("ERR_INVALID_ARG_TYPE",function(t,e){return`The "${t}" argument must be of type number. Received type ${typeof e}`},TypeError),O("ERR_OUT_OF_RANGE",function(t,e,n){let i=`The value of "${t}" is out of range.`,r=n;return Number.isInteger(n)&&Math.abs(n)>4294967296?r=B(String(n)):"bigint"==typeof n&&(r=String(n),(n>BigInt(2)**BigInt(32)||n<-(BigInt(2)**BigInt(32)))&&(r=B(r)),r+="n"),i+=` It must be ${e}. Received ${r}`},RangeError);// HELPER FUNCTIONS
// ================
...
let W=function(){let t="0123456789abcdef",e=Array(256);for(let n=0;n<16;++n){let i=16*n;for(let r=0;r<16;++r)e[i+r]=t[n]+t[r]}return e}();// Return not function with Error if BigInt not supported
function U(t){return"undefined"==typeof BigInt?H:t}function H(){throw Error("BigInt not supported")}}),a("5d11t",function(t,n){e(t.exports,"toByteArray",function(){return i},function(t){return i=t}),e(t.exports,"fromByteArray",function(){return r},function(t){return r=t}),i=function(t){var e,n,i=function(t){var e=t.length;if(e%4>0)throw Error("Invalid string. Length must be a multiple of 4");// Trim off extra bytes after placeholder bytes are found
...
a["-".charCodeAt(0)]=62,a["_".charCodeAt(0)]=63}),a("7rddL",function(t,n){var i,r;e(t.exports,"read",function(){return i},function(t){return i=t}),e(t.exports,"write",function(){return r},function(t){return r=t}),i=function(t,e,n,i,r){var o,a,s=8*r-i-1,l=(1<<s)-1,c=l>>1,u=-7,f=n?r-1:0,p=n?-1:1,d=t[e+f];for(f+=p,o=d&(1<<-u)-1,d>>=-u,u+=s;u>0;o=256*o+t[e+f],f+=p,u-=8);for(a=o&(1<<-u)-1,o>>=-u,u+=i;u>0;a=256*a+t[e+f],f+=p,u-=8);if(0===o)o=1-c;else{if(o===l)return a?NaN:(d?-1:1)*(1/0);a+=Math.pow(2,i),o-=c}return(d?-1:1)*a*Math.pow(2,o-i)},r=function(t,e,n,i,r,o){var a,s,l,c=8*o-r-1,u=(1<<c)-1,f=u>>1,p=23===r?5960464477539062e-23:0,d=i?0:o-1,h=i?1:-1,m=e<0||0===e&&1/e<0?1:0;for(isNaN(e=Math.abs(e))||e===1/0?(s=isNaN(e)?1:0,a=u):(a=Math.floor(Math.log(e)/Math.LN2),e*(l=Math.pow(2,-a))<1&&(a--,l*=2),a+f>=1?e+=p/l:e+=p*Math.pow(2,1-f),e*l>=2&&(a++,l/=2),a+f>=u?(s=0,a=u):a+f>=1?(s=(e*l-1)*Math.pow(2,r),a+=f):(s=e*Math.pow(2,f-1)*Math.pow(2,r),a=0));r>=8;t[n+d]=255&s,d+=h,s/=256,r-=8);for(a=a<<r|s,c+=r;c>0;t[n+d]=255&a,d+=h,a/=256,c-=8);t[n+d-h]|=128*m}}),a("JRZh2",function(t,n){e(t.exports,"default",function(){return r});var i=o("c4C4W"),r=class{constructor(){this.handlers=[]}/**
   ...
   *
   * @returns {void}
   */forEach(t){(0,i.default).forEach(this.handlers,function(e){null!==e&&t(e)})}}}),a("k04r0",function(t,n){e(t.exports,"default",function(){return f});var i=o("jrAxF"),r=o("lXDKh"),a=o("c74ni"),s=o("dW1zJ"),l=o("gHHim"),c=o("fA43c");/**
 * Throws a `CanceledError` if cancellation has been requested.
 *
 * @param {Object} config The config that is to be used for the request
 *
 * @returns {void}
 */function u(t){if(t.cancelToken&&t.cancelToken.throwIfRequested(),t.signal&&t.signal.aborted)throw new s.default(null,t)}function f(t){u(t),t.headers=(0,l.default).from(t.headers),// Transform request data
 ...
 */function(t,e,n){if((0,i.default).isString(t))try{return(0,JSON.parse)(t),(0,i.default).trim(t)}catch(t){if("SyntaxError"!==t.name)throw t}return(0,JSON.stringify)(t)}(t)):t}],transformResponse:[function(t){let e=this.transitional||f.transitional,n=e&&e.forcedJSONParsing,o="json"===this.responseType;if(t&&(0,i.default).isString(t)&&(n&&!this.responseType||o)){let n=e&&e.silentJSONParsing;try{return JSON.parse(t)}catch(t){if(!n&&o){if("SyntaxError"===t.name)throw(0,r.default).from(t,r.default.ERR_BAD_RESPONSE,this,null,this.response);throw t}}}return t}],/**
   * A timeout in milliseconds to abort a request. If set to 0 (default) a
   * timeout is not created.
   */timeout:0,xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",maxContentLength:-1,maxBodyLength:-1,env:{FormData:c.default.classes.FormData,Blob:c.default.classes.Blob},validateStatus:function(t){return t>=200&&t<300},headers:{common:{Accept:"application/json, text/plain, */*","Content-Type":void 0}}};(0,i.default).forEach(["delete","get","head","post","put","patch"],t=>{f.headers[t]={}});var p=f}),a("gWbUy",function(t,n){e(t.exports,"default",function(){return i});var i={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1}}),a("4ue3z",function(t,n){e(t.exports,"default",function(){return s});var i=o("c4C4W"),r=o("12Kat"),a=o("d0XKg");function s(t,e){return(0,r.default)(t,new a.default.classes.URLSearchParams,Object.assign({visitor:function(t,e,n,r){return a.default.isNode&&(0,i.default).isBuffer(t)?(this.append(e,t.toString("base64")),!1):r.defaultVisitor.apply(this,arguments)}},e))}}),a("d0XKg",function(t,n){let i;e(t.exports,"default",function(){return u});var r=o("i5Hs4"),a=o("aIGDF"),s=o("3ZFaa");/**
...
self instanceof WorkerGlobalScope&&"function"==typeof self.importScripts;var u={isBrowser:!0,classes:{URLSearchParams:r.default,FormData:a.default,Blob:s.default},isStandardBrowserEnv:l,isStandardBrowserWebWorkerEnv:c,protocols:["http","https","file","blob","url","data"]}}),a("i5Hs4",function(t,n){e(t.exports,"default",function(){return r});var i=o("8zJup"),r="undefined"!=typeof URLSearchParams?URLSearchParams:i.default}),a("aIGDF",function(t,n){e(t.exports,"default",function(){return i});var i="undefined"!=typeof FormData?FormData:null}),a("3ZFaa",function(t,n){e(t.exports,"default",function(){return i});var i="undefined"!=typeof Blob?Blob:null}),a("gipWz",function(t,n){e(t.exports,"default",function(){return r});var i=o("c4C4W"),r=/**
 ...
 */a=t=>{let e,n,i;let o={};return t&&t.split("\n").forEach(function(t){i=t.indexOf(":"),e=t.substring(0,i).trim().toLowerCase(),n=t.substring(i+1).trim(),!e||o[e]&&r[e]||("set-cookie"===e?o[e]?o[e].push(n):o[e]=[n]:o[e]=o[e]?o[e]+", "+n:n)}),o}}),a("lXDKh",function(t,n){e(t.exports,"default",function(){return i});function i(t){return!!(t&&t.__CANCEL__)}}),a("dW1zJ",function(t,n){e(t.exports,"default",function(){return a});var i=o("5TB86");/**
...
k.onabort=function(){k&&(n(new f.default("Request aborted",f.default.ECONNABORTED,t,k)),// Clean up request
k=null)},// Handle low level network errors
k.onerror=function(){// Real errors are hidden from us by the browser
// onerror should only fire if it's a network error
n(new f.default("Network Error",f.default.ERR_NETWORK,t,k)),// Clean up request
k=null},// Handle timeout
k.ontimeout=function(){let e=t.timeout?"timeout of "+t.timeout+"ms exceeded":"timeout exceeded",i=t.transitional||u.default;t.timeoutErrorMessage&&(e=t.timeoutErrorMessage),n(new f.default(e,i.clarifyTimeoutError?f.default.ETIMEDOUT:f.default.ECONNABORTED,t,k)),// Clean up request
...
o=e=>{k&&(n(!e||e.type?new p.default(null,t,k):e),k.abort(),k=null)},t.cancelToken&&t.cancelToken.subscribe(o),t.signal&&(t.signal.aborted?o():t.signal.addEventListener("abort",o)));let C=(0,d.default)(_);if(C&&-1===(0,h.default).protocols.indexOf(C)){n(new f.default("Unsupported protocol "+C+":",f.default.ERR_BAD_REQUEST,t));return}// Send the request
k.send(x||null)})}}),a("j97bH",function(t,n){e(t.exports,"default",function(){return r});var i=o("5TB86");function r(t,e,n){let r=n.config.validateStatus;!n.status||!r||r(n.status)?t(n):e(new i.default("Request failed with status code "+n.status,[i.default.ERR_BAD_REQUEST,i.default.ERR_BAD_RESPONSE][Math.floor(n.status/100)-4],n.config,n.request,n))}}),a("jFG8L",function(t,n){e(t.exports,"default",function(){return r});var i=o("c4C4W"),r=o("d0XKg").default.isStandardBrowserEnv?{write:function(t,e,n,r,o,a){let s=[];s.push(t+"="+encodeURIComponent(e)),(0,i.default).isNumber(n)&&s.push("expires="+new Date(n).toGMTString()),(0,i.default).isString(r)&&s.push("path="+r),(0,i.default).isString(o)&&s.push("domain="+o),!0===a&&s.push("secure"),document.cookie=s.join("; ")},read:function(t){let e=document.cookie.match(RegExp("(^|;\\s*)("+t+")=([^;]*)"));return e?decodeURIComponent(e[3]):null},remove:function(t){this.write(t,"",Date.now()-864e5)}}:{write:function(){},read:function(){return null},remove:function(){}}}),a("gYMA1",function(t,n){e(t.exports,"default",function(){return a});var i=o("7xjuH"),r=o("ftRZn");function a(t,e){return t&&!(0,i.default)(e)?(0,r.default)(t,e):e}}),a("7xjuH",function(t,n){e(t.exports,"default",function(){return i});function i(t){// A URL is considered absolute if it begins with "<scheme>://" or "//" (protocol-relative URL).
// RFC 3986 defines scheme name as a sequence of characters beginning with a letter and followed
// by any combination of letters, digits, plus, period, or hyphen.
return/^([a-z][a-z\d+\-.]*:)?\/\//i.test(t)}}),a("ftRZn",function(t,n){e(t.exports,"default",function(){return i});function i(t,e){return e?t.replace(/\/+$/,"")+"/"+e.replace(/^\/+/,""):t}}),a("9jFfm",function(t,n){e(t.exports,"default",function(){return r});var i=o("c4C4W"),r=o("d0XKg").default.isStandardBrowserEnv?// whether the request URL is of the same origin as current location.
...
n.setAttribute("href",i),i=n.href),n.setAttribute("href",i),{href:n.href,protocol:n.protocol?n.protocol.replace(/:$/,""):"",host:n.host,search:n.search?n.search.replace(/^\?/,""):"",hash:n.hash?n.hash.replace(/^#/,""):"",hostname:n.hostname,port:n.port,pathname:"/"===n.pathname.charAt(0)?n.pathname:"/"+n.pathname}}/**
    ...
    */return t=r(window.location.href),function(e){let n=(0,i.default).isString(e)?r(e):e;return n.protocol===t.protocol&&n.host===t.host}}():function(){return!0}}),a("4ULKu",function(t,n){e(t.exports,"default",function(){return i});function i(t){let e=/^([-+\w]{1,25})(:?\/\/|:)/.exec(t);return e&&e[1]||""}}),a("dSDGE",function(t,n){e(t.exports,"default",function(){return i});var i=/**
 * Calculate data maxRate
 * @param {Number} [samplesCount= 10]
 * @param {Number} [min= 1000]
 * @returns {Function}
 */function(t,e){let n;t=t||10;let i=Array(t),r=Array(t),o=0,a=0;return e=void 0!==e?e:1e3,function(s){let l=Date.now(),c=r[a];n||(n=l),i[o]=s,r[o]=l;let u=a,f=0;for(;u!==o;)f+=i[u++],u%=t;if((o=(o+1)%t)===a&&(a=(a+1)%t),l-n<e)return;let p=c&&l-c;return p?Math.round(1e3*f/p):void 0}}}),a("knWMA",function(t,n){e(t.exports,"default",function(){return s});var i=o("c4C4W"),r=o("gHHim");let a=t=>t instanceof r.default?t.toJSON():t;function s(t,e){// eslint-disable-next-line no-param-reassign
 ...
 *
 * @returns {object}
 */function(t,e,n){if("object"!=typeof t)throw new r.default("options must be an object",r.default.ERR_BAD_OPTION_VALUE);let i=Object.keys(t),o=i.length;for(;o-- >0;){let a=i[o],s=e[a];if(s){let e=t[a],n=void 0===e||s(e,a,t);if(!0!==n)throw new r.default("option "+a+" must be "+n,r.default.ERR_BAD_OPTION_VALUE);continue}if(!0!==n)throw new r.default("Unknown option "+a,r.default.ERR_BAD_OPTION)}},validators:a}}),a("kLR29",function(t,n){e(t.exports,"VERSION",function(){return i});let i="1.6.0"}),a("77MZz",function(t,n){e(t.exports,"default",function(){return a});var i=o("dW1zJ");/**
...
let i=new Promise(t=>{n.subscribe(t),e=t}).then(t);return i.cancel=function(){n.unsubscribe(e)},i},t(function(t,r,o){n.reason||(n.reason=new i.default(t,r,o),e(n.reason))})}/**
   ...
   */static source(){let t;let e=new r(function(e){t=e});return{token:e,cancel:t}}}var a=r}),a("9BdDr",function(t,n){e(t.exports,"default",function(){return i});function i(t){return function(e){return t.apply(null,e)}}}),a("kv87N",function(t,n){e(t.exports,"default",function(){return r});var i=o("c4C4W");function r(t){return(0,i.default).isObject(t)&&!0===t.isAxiosError}}),a("5siR6",function(t,n){e(t.exports,"default",function(){return r});let i={Continue:100,SwitchingProtocols:101,Processing:102,EarlyHints:103,Ok:200,Created:201,Accepted:202,NonAuthoritativeInformation:203,NoContent:204,ResetContent:205,PartialContent:206,MultiStatus:207,AlreadyReported:208,ImUsed:226,MultipleChoices:300,MovedPermanently:301,Found:302,SeeOther:303,NotModified:304,UseProxy:305,Unused:306,TemporaryRedirect:307,PermanentRedirect:308,BadRequest:400,Unauthorized:401,PaymentRequired:402,Forbidden:403,NotFound:404,MethodNotAllowed:405,NotAcceptable:406,ProxyAuthenticationRequired:407,RequestTimeout:408,Conflict:409,Gone:410,LengthRequired:411,PreconditionFailed:412,PayloadTooLarge:413,UriTooLong:414,UnsupportedMediaType:415,RangeNotSatisfiable:416,ExpectationFailed:417,ImATeapot:418,MisdirectedRequest:421,UnprocessableEntity:422,Locked:423,FailedDependency:424,TooEarly:425,UpgradeRequired:426,PreconditionRequired:428,TooManyRequests:429,RequestHeaderFieldsTooLarge:431,UnavailableForLegalReasons:451,InternalServerError:500,NotImplemented:501,BadGateway:502,ServiceUnavailable:503,GatewayTimeout:504,HttpVersionNotSupported:505,VariantAlsoNegotiates:506,InsufficientStorage:507,LoopDetected:508,NotExtended:510,NetworkAuthenticationRequired:511};Object.entries(i).forEach(([t,e])=>{i[e]=t});var r=i}),a("4T9EK",function(t,e){t.exports=o("aNJCr").getBundleURL("d1WuQ")+"heart-defs.9fecb2e2.svg"}),a("aNJCr",function(t,n){e(t.exports,"getBundleURL",function(){return i},function(t){return i=t});var i,r={};i=function(t){var e=r[t];return e||(e=function(){try{throw Error()}catch(e){var t=(""+e.stack).match(/(https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/[^)\n]+/g);if(t)// Use the 3rd one, which will be a runtime in the original bundle.
return(""+t[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),r[t]=e),e}}),a("i8Q71",function(t,e){let n=document.getElementById("switch"),i=document.getElementById("mobile-switch"),r=document.body;// Функция для применения стилей для текста и фона с атрибутами data-change-color="true", data-change-bg="true", и data-change-background="true" в темной теме
...
r.classList.add("dark-mode"),o()):(// Если переключатель выключен (светлая тема)
r.classList.remove("dark-mode"),a())})}),a("4PiVo",function(t,e){var n=o("g5jnw"),i=o("5UPlY"),r=o("6JpON");let a={categroyList:document.querySelector(".category-list")};(async function(){try{let t=await (0,n.fetchCategories)();a.categroyList.insertAdjacentHTML("beforeend",(0,i.default)(t))}catch(t){console.log(t),(0,r.Notify).failure("Something went wrong. Please try again")}})()}),a("g5jnw",function(t,n){e(t.exports,"fetchCategories",function(){return r}),o("dIxxU");var i=o("ke5Oc");async function r(){try{let t=await (0,i.default).get("https://tasty-treats-backend.p.goit.global/api/categories");return t.data}catch(t){console.log(t)}}}),a("5UPlY",function(n,i){e(n.exports,"default",function(){return s});var r=o("4bnfH");let a=/*@__PURE__*/t(r).template({1:function(t,e,n,i,r){var o=t.lookupProperty||function(t,e){if(Object.prototype.hasOwnProperty.call(t,e))return t[e]};return"  <li class='cat-items'>\n    <button class='category-btn'>"+t.escapeExpression(t.lambda(null!=e?o(e,"name"):e,e))+"</button>\n  </li>\n"},compiler:[8,">= 4.3.0"],main:function(t,e,n,i,r){var o;return null!=(o=(t.lookupProperty||function(t,e){if(Object.prototype.hasOwnProperty.call(t,e))return t[e]})(n,"each").call(null!=e?e:t.nullContext||{},e,{name:"each",hash:{},fn:t.program(1,r,0),inverse:t.noop,data:r,loc:{start:{line:1,column:0},end:{line:5,column:9}}}))?o:""},useData:!0});var s=a}),a("4bnfH",function(t,e){// istanbul ignore next
function n(t){return t&&t.__esModule?t:{default:t}}t.exports.__esModule=!0;var i=n(o("bKObw")),r=n(o("87Xj6")),a=o("kUhmU"),s=o("3FufQ"),l=n(o("cRGkS")),c=n(o("dv4rK")),u=n(o("fnFAe")),f=i.default.create;function p(){var t=f();return t.compile=function(e,n){return s.compile(e,n,t)},t.precompile=function(e,n){return s.precompile(e,n,t)},t.AST=r.default,t.Compiler=s.Compiler,t.JavaScriptCompiler=l.default,t.Parser=a.parser,t.parse=a.parse,t.parseWithoutProcessing=a.parseWithoutProcessing,t}var d=p();d.create=p,u.default(d),d.Visitor=c.default,d.default=d,t.exports.default=d,t.exports=t.exports.default}),a("bKObw",function(t,e){// istanbul ignore next
function n(t){return t&&t.__esModule?t:{default:t}}// istanbul ignore next
function i(t){if(t&&t.__esModule)return t;var e={};if(null!=t)for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e.default=t,e}t.exports.__esModule=!0;var r=i(o("kDlen")),a=n(o("8URuX")),s=n(o("coWwK")),l=i(o("eMPYW")),c=i(o("eAPTX")),u=n(o("fnFAe"));// For compatibility and usage outside of module systems, make the Handlebars object a namespace
function f(){var t=new r.HandlebarsEnvironment;return l.extend(t,r),t.SafeString=a.default,t.Exception=s.default,t.Utils=l,t.escapeExpression=l.escapeExpression,t.VM=c,t.template=function(e){return c.template(e,t)},t}var p=f();p.create=f,u.default(p),p.default=p,t.exports.default=p,t.exports=t.exports.default}),a("kDlen",function(t,n){// istanbul ignore next
function i(t){return t&&t.__esModule?t:{default:t}}e(t.exports,"__esModule",function(){return r},function(t){return r=t}),e(t.exports,"HandlebarsEnvironment",function(){return a},function(t){return a=t}),e(t.exports,"VERSION",function(){return s},function(t){return s=t}),e(t.exports,"COMPILER_REVISION",function(){return l},function(t){return l=t}),e(t.exports,"LAST_COMPATIBLE_COMPILER_REVISION",function(){return c},function(t){return c=t}),e(t.exports,"REVISION_CHANGES",function(){return u},function(t){return u=t}),e(t.exports,"log",function(){return f},function(t){return f=t}),e(t.exports,"createFrame",function(){return p},function(t){return p=t}),e(t.exports,"logger",function(){return d},function(t){return d=t}),r=!0,a=w;var r,a,s,l,c,u,f,p,d,h=o("eMPYW"),m=i(o("coWwK")),g=o("46usK"),y=o("l2i5K"),x=i(o("bo6QS")),b=o("9BZfi");s="4.7.8",l=8,c=7,u={1:"<= 1.0.rc.2",2:"== 1.0.0-rc.3",3:"== 1.0.0-rc.4",4:"== 1.x.x",5:"== 2.0.0-alpha.x",6:">= 2.0.0-beta.1",7:">= 4.0.0 <4.3.0",8:">= 4.3.0"};var v="[object Object]";function w(t,e,n){this.helpers=t||{},this.partials=e||{},this.decorators=n||{},g.registerDefaultHelpers(this),y.registerDefaultDecorators(this)}w.prototype={constructor:w,logger:x.default,log:x.default.log,registerHelper:function(t,e){if(h.toString.call(t)===v){if(e)throw new m.default("Arg not supported with multiple helpers");h.extend(this.helpers,t)}else this.helpers[t]=e},unregisterHelper:function(t){delete this.helpers[t]},registerPartial:function(t,e){if(h.toString.call(t)===v)h.extend(this.partials,t);else{if(void 0===e)throw new m.default('Attempting to register a partial called "'+t+'" as undefined');this.partials[t]=e}},unregisterPartial:function(t){delete this.partials[t]},registerDecorator:function(t,e){if(h.toString.call(t)===v){if(e)throw new m.default("Arg not supported with multiple decorators");h.extend(this.decorators,t)}else this.decorators[t]=e},unregisterDecorator:function(t){delete this.decorators[t]},/**
   * Reset the memory of illegal property accesses that have already been logged.
   * @deprecated should only be used in handlebars test-cases
   */resetLoggedPropertyAccesses:function(){b.resetLoggedProperties()}},f=x.default.log,p=h.createFrame,d=x.default}),a("eMPYW",function(t,n){e(t.exports,"__esModule",function(){return i},function(t){return i=t}),e(t.exports,"extend",function(){return r},function(t){return r=t}),e(t.exports,"indexOf",function(){return o},function(t){return o=t}),e(t.exports,"escapeExpression",function(){return a},function(t){return a=t}),e(t.exports,"isEmpty",function(){return s},function(t){return s=t}),e(t.exports,"createFrame",function(){return l},function(t){return l=t}),e(t.exports,"blockParams",function(){return c},function(t){return c=t}),e(t.exports,"appendContextPath",function(){return u},function(t){return u=t}),e(t.exports,"toString",function(){return f},function(t){return f=t}),e(t.exports,"isFunction",function(){return p},function(t){return p=t}),e(t.exports,"isArray",function(){return d},function(t){return d=t}),i=!0,r=x,o=// Older IE versions do not directly support indexOf so we must implement our own, sadly.
...
t=""+t}return g.test(t)?t.replace(m,y):t},s=function(t){return!t&&0!==t||!!w(t)&&0===t.length},l=function(t){var e=x({},t);return e._parent=t,e},c=function(t,e){return t.path=e,t},u=function(t,e){return(t?t+".":"")+e};var i,r,o,a,s,l,c,u,f,p,d,h={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","`":"&#x60;","=":"&#x3D;"},m=/[&<>"'`=]/g,g=/[&<>"'`=]/;function y(t){return h[t]}function x(t/* , ...source */){for(var e=1;e<arguments.length;e++)for(var n in arguments[e])Object.prototype.hasOwnProperty.call(arguments[e],n)&&(t[n]=arguments[e][n]);return t}var b=Object.prototype.toString;f=b;// Sourced from lodash
// https://github.com/bestiejs/lodash/blob/master/LICENSE.txt
/* eslint-disable func-style */var v=function(t){return"function"==typeof t};v(/x/)&&(p=v=function(t){return"function"==typeof t&&"[object Function]"===b.call(t)}),p=v;/* eslint-enable func-style *//* istanbul ignore next */var w=Array.isArray||function(t){return!!t&&"object"==typeof t&&"[object Array]"===b.call(t)};d=w}),a("coWwK",function(t,e){t.exports.__esModule=!0;var n=["description","fileName","lineNumber","endLineNumber","message","name","number","stack"];function i(t,e){var r=e&&e.loc,o=void 0,a=void 0,s=void 0,l=void 0;r&&(o=r.start.line,a=r.end.line,s=r.start.column,l=r.end.column,t+=" - "+o+":"+s);// Unfortunately errors are not enumerable in Chrome (at least), so `for prop in tmp` doesn't work.
for(var c=Error.prototype.constructor.call(this,t),u=0;u<n.length;u++)this[n[u]]=c[n[u]];/* istanbul ignore else */Error.captureStackTrace&&Error.captureStackTrace(this,i);try{r&&(this.lineNumber=o,this.endLineNumber=a,Object.defineProperty?(Object.defineProperty(this,"column",{value:s,enumerable:!0}),Object.defineProperty(this,"endColumn",{value:l,enumerable:!0})):(this.column=s,this.endColumn=l))}catch(t){/* Ignore if the browser is very particular */}}i.prototype=Error(),t.exports.default=i,t.exports=t.exports.default}),a("46usK",function(t,n){// istanbul ignore next
function i(t){return t&&t.__esModule?t:{default:t}}e(t.exports,"registerDefaultHelpers",function(){return r},function(t){return r=t}),e(t.exports,"moveHelperToHooks",function(){return a},function(t){return a=t}),r=function(t){s.default(t),l.default(t),c.default(t),u.default(t),f.default(t),p.default(t),d.default(t)},a=function(t,e,n){t.helpers[e]&&(t.hooks[e]=t.helpers[e],n||delete t.helpers[e])};var r,a,s=i(o("dPa8P")),l=i(o("kJv74")),c=i(o("inHfM")),u=i(o("kTSLa")),f=i(o("9Mlm3")),p=i(o("bs5fN")),d=i(o("5MKji"))}),a("dPa8P",function(t,e){t.exports.__esModule=!0;var n=o("eMPYW");t.exports.default=function(t){t.registerHelper("blockHelperMissing",function(e,i){var r=i.inverse,o=i.fn;if(!0===e)return o(this);if(!1===e||null==e)return r(this);if(n.isArray(e))return e.length>0?(i.ids&&(i.ids=[i.name]),t.helpers.each(e,i)):r(this);if(i.data&&i.ids){var a=n.createFrame(i.data);a.contextPath=n.appendContextPath(i.data.contextPath,i.name),i={data:a}}return o(e,i)})},t.exports=t.exports.default}),a("kJv74",function(t,e){t.exports.__esModule=!0;var n,i=o("eMPYW"),r=(n=o("coWwK"))&&n.__esModule?n:{default:n};t.exports.default=function(t){t.registerHelper("each",function(t,e){if(!e)throw new r.default("Must pass iterator to #each");var n=e.fn,o=e.inverse,a=0,s="",l=void 0,c=void 0;function u(e,r,o){l&&(l.key=e,l.index=r,l.first=0===r,l.last=!!o,c&&(l.contextPath=c+e)),s+=n(t[e],{data:l,blockParams:i.blockParams([t[e],e],[c+e,null])})}if(e.data&&e.ids&&(c=i.appendContextPath(e.data.contextPath,e.ids[0])+"."),i.isFunction(t)&&(t=t.call(this)),e.data&&(l=i.createFrame(e.data)),t&&"object"==typeof t){if(i.isArray(t))for(var f,p=t.length;a<p;a++)a in t&&u(a,a,a===t.length-1);else if("function"==typeof Symbol&&t[Symbol.iterator]){for(var d=[],h=t[Symbol.iterator](),m=h.next();!m.done;m=h.next())d.push(m.value);t=d;for(var p=t.length;a<p;a++)u(a,a,a===t.length-1)}else f=void 0,Object.keys(t).forEach(function(t){void 0!==f&&u(f,a-1),f=t,a++}),void 0!==f&&u(f,a-1,!0)}return 0===a&&(s=o(this)),s})},t.exports=t.exports.default}),a("inHfM",function(t,e){t.exports.__esModule=!0;var n,i=(n=o("coWwK"))&&n.__esModule?n:{default:n};t.exports.default=function(t){t.registerHelper("helperMissing",function()/* [args, ]options */{if(1!=arguments.length)throw new i.default('Missing helper: "'+arguments[arguments.length-1].name+'"')})},t.exports=t.exports.default}),a("kTSLa",function(t,e){t.exports.__esModule=!0;var n,i=o("eMPYW"),r=(n=o("coWwK"))&&n.__esModule?n:{default:n};t.exports.default=function(t){t.registerHelper("if",function(t,e){if(2!=arguments.length)throw new r.default("#if requires exactly one argument");return(// Default behavior is to render the positive path if the value is truthy and not empty.
// The `includeZero` option may be set to treat the condtional as purely not empty based on the
// behavior of isEmpty. Effectively this determines if 0 is handled by the positive path or negative.
(i.isFunction(t)&&(t=t.call(this)),!e.hash.includeZero&&!t||i.isEmpty(t))?e.inverse(this):e.fn(this))}),t.registerHelper("unless",function(e,n){if(2!=arguments.length)throw new r.default("#unless requires exactly one argument");return t.helpers.if.call(this,e,{fn:n.inverse,inverse:n.fn,hash:n.hash})})},t.exports=t.exports.default}),a("9Mlm3",function(t,e){t.exports.__esModule=!0,t.exports.default=function(t){t.registerHelper("log",function()/* message, options */{for(var e=[void 0],n=arguments[arguments.length-1],i=0;i<arguments.length-1;i++)e.push(arguments[i]);var r=1;null!=n.hash.level?r=n.hash.level:n.data&&null!=n.data.level&&(r=n.data.level),e[0]=r,t.log.apply(t,e)})},t.exports=t.exports.default}),a("bs5fN",function(t,e){t.exports.__esModule=!0,t.exports.default=function(t){t.registerHelper("lookup",function(t,e,n){return t?n.lookupProperty(t,e):t})},t.exports=t.exports.default}),a("5MKji",function(t,e){t.exports.__esModule=!0;var n,i=o("eMPYW"),r=(n=o("coWwK"))&&n.__esModule?n:{default:n};t.exports.default=function(t){t.registerHelper("with",function(t,e){if(2!=arguments.length)throw new r.default("#with requires exactly one argument");i.isFunction(t)&&(t=t.call(this));var n=e.fn;if(i.isEmpty(t))return e.inverse(this);var o=e.data;return e.data&&e.ids&&((o=i.createFrame(e.data)).contextPath=i.appendContextPath(e.data.contextPath,e.ids[0])),n(t,{data:o,blockParams:i.blockParams([t],[o&&o.contextPath])})})},t.exports=t.exports.default}),a("l2i5K",function(t,n){e(t.exports,"registerDefaultDecorators",function(){return i},function(t){return i=t}),i=function(t){a.default(t)};var i,r,a=(r=o("6OSef"))&&r.__esModule?r:{default:r}}),a("6OSef",function(t,e){t.exports.__esModule=!0;var n=o("eMPYW");t.exports.default=function(t){t.registerDecorator("inline",function(t,e,i,r){var o=t;return e.partials||(e.partials={},o=function(r,o){// Create a new partials stack frame prior to exec.
var a=i.partials;i.partials=n.extend({},a,e.partials);var s=t(r,o);return i.partials=a,s}),e.partials[r.args[0]]=r.fn,o})},t.exports=t.exports.default}),a("bo6QS",function(t,e){t.exports.__esModule=!0;var n=o("eMPYW"),i={methodMap:["debug","info","warn","error"],level:"info",// Maps a given level value to the `methodMap` indexes above.
...
var n=t.compiler&&7===t.compiler[0],i={strict:function(t,e,n){if(!t||!(e in t))throw new d.default('"'+e+'" not defined in '+t,{loc:n});return i.lookupProperty(t,e)},lookupProperty:function(t,e){var n=t[e];if(null==n||Object.prototype.hasOwnProperty.call(t,e)||y.resultIsAllowed(n,i.protoAccessControl,e))return n},lookup:function(t,e){for(var n=t.length,r=0;r<n;r++)if(null!=(t[r]&&i.lookupProperty(t[r],e)))return t[r][e]},lambda:function(t,e){return"function"==typeof t?t.call(e):t},escapeExpression:p.escapeExpression,invokePartial:function(n,i,r){r.hash&&(i=p.extend({},i,r.hash),r.ids&&(r.ids[0]=!0)),n=e.VM.resolvePartial.call(this,n,i,r);var o=p.extend({},r,{hooks:this.hooks,protoAccessControl:this.protoAccessControl}),a=e.VM.invokePartial.call(this,n,i,o);if(null==a&&e.compile&&(r.partials[r.name]=e.compile(n,t.compilerOptions,e),a=r.partials[r.name](i,o)),null!=a){if(r.indent){for(var s=a.split("\n"),l=0,c=s.length;l<c&&(s[l]||l+1!==c);l++)s[l]=r.indent+s[l];a=s.join("\n")}return a}throw new d.default("The partial "+r.name+" could not be compiled when running in runtime-only mode")},fn:function(e){var n=t[e];return n.decorator=t[e+"_d"],n},programs:[],program:function(t,e,n,i,r){var o=this.programs[t],a=this.fn(t);return e||r||i||n?o=x(this,t,a,e,n,i,r):o||(o=this.programs[t]=x(this,t,a)),o},data:function(t,e){for(;t&&e--;)t=t._parent;return t},mergeIfNeeded:function(t,e){var n=t||e;return t&&e&&t!==e&&(n=p.extend({},e,t)),n},// An empty object to use as replacement for null-contexts
nullContext:Object.seal({}),noop:e.VM.noop,compilerInfo:t.compiler};function r(e){var n,o=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],a=o.data;r._setup(o),!o.partial&&t.useData&&((n=a)&&"root"in n||((n=n?h.createFrame(n):{}).root=e),a=n);var s=void 0,l=t.useBlockParams?[]:void 0;function c(e/*, options*/){return""+t.main(i,e,i.helpers,i.partials,a,l,s)}return t.useDepths&&(s=o.depths?e!=o.depths[0]?[e].concat(o.depths):o.depths:[e]),(c=v(t.main,c,i,o.depths||[],a,l))(e,o)}return r.isTop=!0,r._setup=function(r){if(r.partial)i.protoAccessControl=r.protoAccessControl,i.helpers=r.helpers,i.partials=r.partials,i.decorators=r.decorators,i.hooks=r.hooks;else{var o=p.extend({},e.helpers,r.helpers);(function(t,e){Object.keys(t).forEach(function(n){var i,r=t[n];t[n]=(i=e.lookupProperty,g.wrapHelper(r,function(t){return p.extend({lookupProperty:i},t)}))})})(o,i),i.helpers=o,t.usePartial&&(i.partials=i.mergeIfNeeded(r.partials,e.partials)),(t.usePartial||t.useDecorators)&&(i.decorators=p.extend({},e.decorators,r.decorators)),i.hooks={},i.protoAccessControl=y.createProtoAccessControl(r);var a=r.allowCallsToHelperMissing||n;m.moveHelperToHooks(i,"helperMissing",a),m.moveHelperToHooks(i,"blockHelperMissing",a)}},r._child=function(e,n,r,o){if(t.useBlockParams&&!r)throw new d.default("must pass block params");if(t.useDepths&&!o)throw new d.default("must pass parent depths");return x(i,e,t[e],n,0,r,o)},r},s=x,l=/**
...
e.data=h.createFrame(e.data),e.data["partial-block"]=r,i(t,e))},i.partials&&(n.partials=p.extend({},n.partials,i.partials))),void 0===t&&o&&(t=o),void 0===t)throw new d.default("The partial "+n.name+" could not be found");if(t instanceof Function)return t(e,n)},u=b;var i,r,a,s,l,c,u,f,p=// istanbul ignore next
function(t){if(t&&t.__esModule)return t;var e={};if(null!=t)for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e.default=t,e}(o("eMPYW")),d=(f=o("coWwK"))&&f.__esModule?f:{default:f},h=o("kDlen"),m=o("46usK"),g=o("bRmie"),y=o("9BZfi");function x(t,e,n,i,r,o,a){function s(e){var r=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],s=a;return a&&e!=a[0]&&!(e===t.nullContext&&null===a[0])&&(s=[e].concat(a)),n(t,e,t.helpers,t.partials,r.data||i,o&&[r.blockParams].concat(o),s)}return(s=v(n,s,t,a,i,o)).program=e,s.depth=a?a.length:0,s.blockParams=r||0,s}function b(){return""}function v(t,e,n,i,r,o){if(t.decorator){var a={};e=t.decorator(e,a,n,i&&i[0],r,o,i),p.extend(e,a)}return e}}),a("bRmie",function(t,n){var i;e(t.exports,"wrapHelper",function(){return i},function(t){return i=t}),i=function(t,e){return"function"!=typeof t?t:function()/* dynamic arguments */{var n=arguments[arguments.length-1];return arguments[arguments.length-1]=e(n),t.apply(this,arguments)}}}),a("fnFAe",function(t,e){t.exports.__esModule=!0,t.exports.default=function(t){"object"!=typeof globalThis&&(Object.prototype.__defineGetter__("__magic__",function(){return this}),__magic__.globalThis=__magic__,delete Object.prototype.__magic__);var e=globalThis.Handlebars;/* istanbul ignore next */t.noConflict=function(){return globalThis.Handlebars===t&&(globalThis.Handlebars=e),t}},t.exports=t.exports.default}),a("87Xj6",function(t,e){t.exports.__esModule=!0;var n={// Public API used to evaluate derived attributes regarding AST nodes
...
var r=i.value;return i.value=i.value.replace(n?/\s+$/:/[ \t]+$/,""),i.leftStripped=i.value!==r,i.leftStripped}}r.prototype=new i.default,r.prototype.Program=function(t){var e=!this.options.ignoreStandalone,n=!this.isRootSeen;this.isRootSeen=!0;for(var i=t.body,r=0,o=i.length;r<o;r++){var u=i[r],f=this.accept(u);if(f){var p=a(i,r,n),d=s(i,r,n),h=f.openStandalone&&p,m=f.closeStandalone&&d,g=f.inlineStandalone&&p&&d;f.close&&l(i,r,!0),f.open&&c(i,r,!0),e&&g&&(l(i,r),c(i,r)&&"PartialStatement"===u.type&&(u.indent=/([ \t]+$)/.exec(i[r-1].original)[1])),e&&h&&(l((u.program||u.inverse).body),// Strip out the previous content node if it's whitespace only
...
p.prototype={compiler:p,equals:function(t){var e=this.opcodes.length;if(t.opcodes.length!==e)return!1;for(var n=0;n<e;n++){var i=this.opcodes[n],r=t.opcodes[n];if(i.opcode!==r.opcode||!function t(e,n){if(e===n)return!0;if(c.isArray(e)&&c.isArray(n)&&e.length===n.length){for(var i=0;i<e.length;i++)if(!t(e[i],n[i]))return!1;return!0}}(i.args,r.args))return!1}// We know that length is the same between the two arrays because they are directly tied
...
this.accept(t);else{if(this.trackIds){var n=void 0;if(!t.parts||u.default.helpers.scopedId(t)||t.depth||(n=this.blockParamIndex(t.parts[0])),n){var i=t.parts.slice(1).join(".");this.opcode("pushId","BlockParam",n,i)}else(e=t.original||e).replace&&(e=e.replace(/^this(?:\.|$)/,"").replace(/^\.\//,"").replace(/^\.$/,"")),this.opcode("pushId",t.type,e)}this.accept(t)}},setupFullMustacheParams:function(t,e,n,i){var r=t.params;return this.pushParams(r),this.opcode("pushProgram",e),this.opcode("pushProgram",n),t.hash?this.accept(t.hash):this.opcode("emptyHash",i),r},blockParamIndex:function(t){for(var e=0,n=this.options.blockParams.length;e<n;e++){var i=this.options.blockParams[e],r=i&&c.indexOf(i,t);if(i&&r>=0)return[e,r]}}}}),a("cRGkS",function(t,e){// istanbul ignore next
function n(t){return t&&t.__esModule?t:{default:t}}t.exports.__esModule=!0;var i=o("kDlen"),r=n(o("coWwK")),a=o("eMPYW"),s=n(o("b96jT"));function l(t){this.value=t}function c(){}c.prototype={// PUBLIC API: You can override these methods in a subclass to provide
...
this.source.currentLocation=s,this.pushSource(""),this.stackSlot||this.inlineStack.length||this.compileStack.length)throw new r.default("Compile completed with content left on stack");this.decorators.isEmpty()?this.decorators=void 0:(this.useDecorators=!0,this.decorators.prepend(["var decorators = container.decorators, ",this.lookupPropertyFunctionVarDeclaration(),";\n"]),this.decorators.push("return fn;"),i?this.decorators=Function.apply(this,["fn","props","container","depth0","data","blockParams","depths",this.decorators.merge()]):(this.decorators.prepend("function(fn, props, container, depth0, data, blockParams, depths) {\n"),this.decorators.push("}\n"),this.decorators=this.decorators.merge()));var u=this.createFunctionContext(i);if(this.isChild)return u;var f={compiler:this.compilerInfo(),main:u};this.decorators&&(f.main_d=this.decorators,f.useDecorators=!0);var p=this.context,d=p.programs,h=p.decorators;for(l=0,c=d.length;l<c;l++)d[l]&&(f[l]=d[l],h[l]&&(f[l+"_d"]=h[l],f.useDecorators=!0));return this.environment.usePartial&&(f.usePartial=!0),this.options.data&&(f.useData=!0),this.useDepths&&(f.useDepths=!0),this.useBlockParams&&(f.useBlockParams=!0),this.options.compat&&(f.compat=!0),i?f.compilerOptions=this.options:(f.compiler=JSON.stringify(f.compiler),this.source.currentLocation={start:{line:1,column:0}},f=this.objectLiteral(f),e.srcName?(f=f.toStringWithSourceMap({file:e.destName})).map=f.map&&f.map.toString():f=f.toString()),f},preamble:function(){// track the last context pushed into place to allow skipping the
...
var f=e;f--;)l=this.popStack(),n[f]=l,this.trackIds&&(a[f]=this.popStack()),this.stringParams&&(o[f]=this.popStack(),r[f]=this.popStack());return s&&(i.args=this.source.generateArray(n)),this.trackIds&&(i.ids=this.source.generateArray(a)),this.stringParams&&(i.types=this.source.generateArray(o),i.contexts=this.source.generateArray(r)),this.options.data&&(i.data="data"),this.useBlockParams&&(i.blockParams="blockParams"),i},setupHelperArgs:function(t,e,n,i){var r=this.setupParams(t,e,n);return(r.loc=JSON.stringify(this.source.currentLocation),r=this.objectLiteral(r),i)?(this.useRegister("options"),n.push("options"),["options=",r]):n?(n.push(r),""):r}},function(){for(var t="break else new var case finally return void catch for switch while continue function this with default if throw delete in try do instanceof typeof abstract enum int short boolean export interface static byte extends long super char final native synchronized class float package throws const goto private transient debugger implements protected volatile double import public let yield await null true false".split(" "),e=c.RESERVED_WORDS={},n=0,i=t.length;n<i;n++)e[t[n]]=!0}(),/**
 * @deprecated May be removed in the next major version
 */c.isValidJavaScriptVariableName=function(t){return!c.RESERVED_WORDS[t]&&/^[a-zA-Z_$][0-9a-zA-Z_$]*$/.test(t)},t.exports.default=c,t.exports=t.exports.default}),a("b96jT",function(t,e){t.exports.__esModule=!0;var n=o("eMPYW"),i=void 0;try{/* istanbul ignore next */"function"==typeof define&&define.amd||(i=o("hTBva").SourceNode)}catch(t){}function r(t,e,i){if(n.isArray(t)){for(var r=[],o=0,a=t.length;o<a;o++)r.push(e.wrap(t[o],i));return r}return"boolean"==typeof t||"number"==typeof t?t+"":t}function a(t){this.srcFile=t,this.source=[]}i||/* istanbul ignore next */((i=function(t,e,n,i){this.src="",i&&this.add(i)}).prototype={add:function(t){n.isArray(t)&&(t=t.join("")),this.src+=t},prepend:function(t){n.isArray(t)&&(t=t.join("")),this.src=t+this.src},toStringWithSourceMap:function(){return{code:this.toString()}},toString:function(){return this.src}}),a.prototype={isEmpty:function(){return!this.source.length},prepend:function(t,e){this.source.unshift(this.wrap(t,e))},push:function(t,e){this.source.push(this.wrap(t,e))},merge:function(){var t=this.empty();return this.each(function(e){t.add(["  ",e,"\n"])}),t},each:function(t){for(var e=0,n=this.source.length;e<n;e++)t(this.source[e])},empty:function(){var t=this.currentLocation||{start:{}};return new i(t.start.line,t.start.column,this.srcFile)},wrap:function(t){var e=arguments.length<=1||void 0===arguments[1]?this.currentLocation||{start:{}}:arguments[1];return t instanceof i?t:(t=r(t,this,e),new i(e.start.line,e.start.column,this.srcFile,t))},functionCall:function(t,e,n){return n=this.generateList(n),this.wrap([t,e?"."+e+"(":"(",n,")"])},quotedString:function(t){return'"'+(t+"").replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\n/g,"\\n").replace(/\r/g,"\\r").replace(/\u2028/g,"\\u2028")// Per Ecma-262 7.3 + 7.8.4
.replace(/\u2029/g,"\\u2029")+'"'},objectLiteral:function(t){// istanbul ignore next
var e=this,n=[];Object.keys(t).forEach(function(i){var o=r(t[i],e);"undefined"!==o&&n.push([e.quotedString(i),":",o])});var i=this.generateList(n);return i.prepend("{"),i.add("}"),i},generateList:function(t){for(var e=this.empty(),n=0,i=t.length;n<i;n++)n&&e.add(","),e.add(r(t[n],this));return e},generateArray:function(t){var e=this.generateList(t);return e.prepend("["),e.add("]"),e}},t.exports.default=a,t.exports=t.exports.default}),a("hTBva",function(t,n){var i,r,a;e(t.exports,"SourceMapGenerator",function(){return i},function(t){return i=t}),e(t.exports,"SourceMapConsumer",function(){return r},function(t){return r=t}),e(t.exports,"SourceNode",function(){return a},function(t){return a=t}),i=o("8JAU7").SourceMapGenerator,r=o("4SEMF").SourceMapConsumer,a=o("fLrsR").SourceNode}),a("8JAU7",function(t,n){e(t.exports,"SourceMapGenerator",function(){return i},function(t){return i=t});var i,r=o("1d7dz"),a=o("cUiFn"),s=o("ccQ4s").ArraySet,l=o("66k9l").MappingList;/**
 ...
 */c.prototype._serializeMappings=function(){for(var t,e,n,i,o=0,s=1,l=0,c=0,u=0,f=0,p="",d=this._mappings.toArray(),h=0,m=d.length;h<m;h++){if(e=d[h],t="",e.generatedLine!==s)for(o=0;e.generatedLine!==s;)t+=";",s++;else if(h>0){if(!a.compareByGeneratedPositionsInflated(e,d[h-1]))continue;t+=","}t+=r.encode(e.generatedColumn-o),o=e.generatedColumn,null!=e.source&&(i=this._sources.indexOf(e.source),t+=r.encode(i-f),f=i,// lines are stored 0-based in SourceMap spec version 3
 ...
 */c.prototype.toString=function(){return JSON.stringify(this.toJSON())},i=c}),a("1d7dz",function(t,n){e(t.exports,"encode",function(){return i},function(t){return i=t}),e(t.exports,"decode",function(){return r},function(t){return r=t});var i,r,a=o("ahpWO");i=function(t){var e,n="",i=t<0?(-t<<1)+1:(t<<1)+0;do e=31&i,(i>>>=5)>0&&// continuation bit is marked.
(e|=32),n+=a.encode(e);while(i>0)return n},r=function(t,e,n){var i,r,o,s,l=t.length,c=0,u=0;do{if(e>=l)throw Error("Expected more digits in base 64 VLQ value.");if(-1===(s=a.decode(t.charCodeAt(e++))))throw Error("Invalid base64 digit: "+t.charAt(e-1));o=!!(32&s),s&=31,c+=s<<u,u+=5}while(o)n.value=(r=(i=c)>>1,(1&i)==1?-r:r),n.rest=e}}),a("ahpWO",function(t,n){e(t.exports,"encode",function(){return i},function(t){return i=t}),e(t.exports,"decode",function(){return r},function(t){return r=t});var i,r,o="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".split("");i=function(t){if(0<=t&&t<o.length)return o[t];throw TypeError("Must be between 0 and 63: "+t)},r=function(t){return(// 0 - 25: ABCDEFGHIJKLMNOPQRSTUVWXYZ
65<=t&&t<=90?t-65:97<=t&&t<=122?t-97+26:48<=t&&t<=57?t-48+52:43==t?62:47==t?63:-1)}}),a("cUiFn",function(t,n){e(t.exports,"getArg",function(){return i},function(t){return i=t}),e(t.exports,"urlParse",function(){return r},function(t){return r=t}),e(t.exports,"isAbsolute",function(){return s},function(t){return s=t}),e(t.exports,"normalize",function(){return o},function(t){return o=t}),e(t.exports,"join",function(){return a},function(t){return a=t}),e(t.exports,"relative",function(){return l},function(t){return l=t}),e(t.exports,"toSetString",function(){return c},function(t){return c=t}),e(t.exports,"fromSetString",function(){return u},function(t){return u=t}),e(t.exports,"compareByOriginalPositions",function(){return f},function(t){return f=t}),e(t.exports,"compareByGeneratedPositionsDeflated",function(){return p},function(t){return p=t}),e(t.exports,"compareByGeneratedPositionsInflated",function(){return d},function(t){return d=t}),e(t.exports,"parseSourceMapInput",function(){return h},function(t){return h=t}),e(t.exports,"computeSourceURL",function(){return m},function(t){return m=t}),i=function(t,e,n){if(e in t)return t[e];if(3==arguments.length)return n;throw Error('"'+e+'" is a required argument.')};var i,r,o,a,s,l,c,u,f,p,d,h,m,g=/^(?:([\w+\-.]+):)?\/\/(?:(\w+:\w+)@)?([\w.-]*)(?::(\d+))?(.*)$/,y=/^data:.+\,.+$/;function x(t){var e=t.match(g);return e?{scheme:e[1],auth:e[2],host:e[3],port:e[4],path:e[5]}:null}function b(t){var e="";return t.scheme&&(e+=t.scheme+":"),e+="//",t.auth&&(e+=t.auth+"@"),t.host&&(e+=t.host),t.port&&(e+=":"+t.port),t.path&&(e+=t.path),e}/**
 ...
 *
 * @param String aStr
 */function(t){return S(t)?"$"+t:t},u=k?_:function(t){return S(t)?t.slice(1):t},f=/**
 ...
 * stubbed out mapping.
 */function(t,e,n){var i=C(t.source,e.source);return 0!==i||0!=(i=t.originalLine-e.originalLine)||0!=(i=t.originalColumn-e.originalColumn)||n||0!=(i=t.generatedColumn-e.generatedColumn)||0!=(i=t.generatedLine-e.generatedLine)?i:C(t.name,e.name)},p=/**
...
var r=i.path.lastIndexOf("/");r>=0&&(i.path=i.path.substring(0,r+1))}e=w(b(i),e)}return v(e)}}),a("ccQ4s",function(t,n){e(t.exports,"ArraySet",function(){return i},function(t){return i=t});var i,r=o("cUiFn"),a=Object.prototype.hasOwnProperty,s="undefined"!=typeof Map;/**
 ...
 */l.prototype.toArray=function(){return this._array.slice()},i=l}),a("66k9l",function(t,n){e(t.exports,"MappingList",function(){return i},function(t){return i=t});var i,r=o("cUiFn");/**
 ...
 * copy.
 */a.prototype.toArray=function(){return this._sorted||(this._array.sort(r.compareByGeneratedPositionsInflated),this._sorted=!0),this._array},i=a}),a("4SEMF",function(t,n){e(t.exports,"SourceMapConsumer",function(){return i},function(t){return i=t});var i,r=o("cUiFn"),a=o("k488Y"),s=o("ccQ4s").ArraySet,l=o("1d7dz"),c=o("hkFn3").quickSort;function u(t,e){var n=t;return"string"==typeof t&&(n=r.parseSourceMapInput(t)),null!=n.sections?new d(n,e):new f(n,e)}/**
 ...
 */function f(t,e){var n=t;"string"==typeof t&&(n=r.parseSourceMapInput(t));var i=r.getArg(n,"version"),o=r.getArg(n,"sources"),a=r.getArg(n,"names",[]),l=r.getArg(n,"sourceRoot",null),c=r.getArg(n,"sourcesContent",null),u=r.getArg(n,"mappings"),f=r.getArg(n,"file",null);// Once again, Sass deviates from the spec and supplies the version as a
...
this._names=s.fromArray(a.map(String),!0),this._sources=s.fromArray(o,!0),this._absoluteSources=this._sources.toArray().map(function(t){return r.computeSourceURL(l,t,e)}),this.sourceRoot=l,this.sourcesContent=c,this._mappings=u,this._sourceMapURL=e,this.file=f}/**
...
generatedLine:i+1,generatedColumn:o+1},consumer:new u(r.getArg(t,"map"),e)}})}u.fromSourceMap=function(t,e){return f.fromSourceMap(t,e)},/**
...
for(var c=s.originalColumn;s&&s.originalLine===e&&s.originalColumn==c;)i.push({line:r.getArg(s,"generatedLine",null),column:r.getArg(s,"generatedColumn",null),lastColumn:r.getArg(s,"lastGeneratedColumn",null)}),s=this._originalMappings[++o]}return i},i=u,f.prototype=Object.create(u.prototype),f.prototype.consumer=u,/**
 * Utility function to find the index of a source.  Returns -1 if not
 * found.
 */f.prototype._findSourceIndex=function(t){var e,n=t;if(null!=this.sourceRoot&&(n=r.relative(this.sourceRoot,n)),this._sources.has(n))return this._sources.indexOf(n);for(e=0;e<this._absoluteSources.length;++e)if(this._absoluteSources[e]==t)return e;return -1},/**
 ...
 */f.prototype._findMapping=function(t,e,n,i,r,o){// To return the position we are searching for, we must first find the
 ...
 * inclusive.
 */f.prototype.computeColumnSpans=function(){for(var t=0;t<this._generatedMappings.length;++t){var e=this._generatedMappings[t];// Mappings do not contain a field for the last generated columnt. We
 ...
 * map, false otherwise.
 */f.prototype.hasContentsOfAllSources=function(){return!!this.sourcesContent&&this.sourcesContent.length>=this._sources.size()&&!this.sourcesContent.some(function(t){return null==t})},/**
 * Returns the original source content. The only argument is the url of the
 * original source file. Returns null if no original source content is
 * available.
 */f.prototype.sourceContentFor=function(t,e){if(!this.sourcesContent)return null;var n,i=this._findSourceIndex(t);if(i>=0)return this.sourcesContent[i];var o=t;if(null!=this.sourceRoot&&(o=r.relative(this.sourceRoot,o)),null!=this.sourceRoot&&(n=r.urlParse(this.sourceRoot))){// XXX: file:// URIs and absolute paths lead to unexpected behavior for
...
// generated file.
var f={source:l,generatedLine:s.generatedLine+(i.generatedOffset.generatedLine-1),generatedColumn:s.generatedColumn+(i.generatedOffset.generatedLine===s.generatedLine?i.generatedOffset.generatedColumn-1:0),originalLine:s.originalLine,originalColumn:s.originalColumn,name:u};this.__generatedMappings.push(f),"number"==typeof f.originalLine&&this.__originalMappings.push(f)}c(this.__generatedMappings,r.compareByGeneratedPositionsDeflated),c(this.__originalMappings,r.compareByOriginalPositions)}}),a("k488Y",function(t,n){var i,r,o;e(t.exports,"GREATEST_LOWER_BOUND",function(){return i},function(t){return i=t}),e(t.exports,"LEAST_UPPER_BOUND",function(){return r},function(t){return r=t}),e(t.exports,"search",function(){return o},function(t){return o=t}),i=1,r=2,o=function(t,e,n,o){if(0===e.length)return -1;var a=/**
...
for(;a-1>=0&&0===n(e[a],e[a-1],!0);)--a;return a}}),a("hkFn3",function(t,n){var i;function r(t,e,n){var i=t[e];t[e]=t[n],t[n]=i}e(t.exports,"quickSort",function(){return i},function(t){return i=t}),i=function(t,e){!/**
...
t(e,n,i,u-1),t(e,n,u+1,o)}}(t,e,0,t.length-1)}}),a("fLrsR",function(t,n){e(t.exports,"SourceNode",function(){return i},function(t){return i=t});var i,r=o("8JAU7").SourceMapGenerator,a=o("cUiFn"),s=/(\r?\n)/,l="$$$isSourceNode$$$";/**
...
// and the SourceMap
var i=new c,r=t.split(s),o=0,l=function(){return t()+(t()||"");function t(){return o<r.length?r[o++]:void 0}},u=1,f=0,p=null;return e.eachMapping(function(t){if(null!==p){// We add the code from "lastMapping" to "mapping":
// First check if there is a new line in between.
if(u<t.generatedLine)// Associate first line with "lastMapping"
d(p,l()),u++,f=0;else{// There is no new line in between.
// Associate the code between "lastGeneratedColumn" and
// "mapping.generatedColumn" with "lastMapping"
var e=r[o]||"",n=e.substr(0,t.generatedColumn-f);r[o]=e.substr(t.generatedColumn-f),f=t.generatedColumn,d(p,n),// No more remaining code, continue
p=t;return}}// We add the generated code until the first mapping
// to the SourceNode without any mapping.
// Each line is added as separate string.
for(;u<t.generatedLine;)i.add(l()),u++;if(f<t.generatedColumn){var e=r[o]||"";i.add(e.substr(0,t.generatedColumn)),r[o]=e.substr(t.generatedColumn),f=t.generatedColumn}p=t},this),o<r.length&&(p&&d(p,l()),// and add the remaining lines without any mapping
...
//   });
// });
})}();//# sourceMappingURL=favorites.17a8fc25.js.map
